...
CREATE TABLE `enfermedad_actual` (
  ...
  `estado_general` varchar(500) DEFAULT NULL,
  `peso` int DEFAULT NULL,
  `talla` int DEFAULT NULL,
  `enfermedad_actual` int DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `enfermedad_actual`
--

LOCK TABLES `enfermedad_actual` WRITE;
/*!40000 ALTER TABLE `enfermedad_actual` DISABLE KEYS */;
/*!40000 ALTER TABLE `enfermedad_actual` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2023-11-30 20:04:20
